FullScreenMario.prototype.settings.ui = {
    ...
    "styleSheet": {
        ...
        "@font-face": {
            ...
            "src": [
                    "url('mario/Fonts/pressstart2p-webfont.eot?#iefix') format('embedded-opentype')",
                    "url('mario/Fonts/pressstart2p-webfont.woff') format('woff')",
                    "url('mario/Fonts/pressstart2p-webfont.ttf') format('truetype')",
                    "url('mario/Fonts/pressstart2p-webfont.svg') format('svg')"
                ].join(", "),
            "font-weight": "normal",
            "font-style": "normal"
        }
